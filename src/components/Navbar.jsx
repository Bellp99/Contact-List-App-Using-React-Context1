	...
	return (
		<nav className="navbar navbar-light bg-light m-3">
			<div className="container">
				<Link to="/">
					<span className="navbar-brand mb-0 h1 fs-1">
						<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-card-checklist m-3" viewBox="0 0 16 16">
				...
				<div className="ml-auto">
					<Link to="/addcontact">
						<button className="btn btn-outline-dark btn-lg">Add Contact</button>
					</Link>
				</div>
			</div>
		</nav>
